<!-- resources/views/set_alert.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body class="bg-gray-200">
    <div class="flex items-center justify-center h-screen">
        <div class="max-w-sm rounded overflow-hidden">
            <form action="/set_alert" method="post" class="bg-white shadow-md rounded px-8 pt-8 pb-12 mb-4">
                @csrf
                <div class="mb-4">
                ...
                <div class="mb-6">
                    ...
                    Alert for slot prior to
                    </label>
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="notif_date" id="date" type="date" required>
                </div>
                <div class="flex items-center justify-between">
                    <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Set Alert</button>
